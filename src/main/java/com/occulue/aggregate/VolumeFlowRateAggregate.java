...
public class VolumeFlowRateAggregate {  
    ...
    public VolumeFlowRateAggregate(CreateVolumeFlowRateCommand command) throws Exception {
    	...
    	CreateVolumeFlowRateEvent event = new CreateVolumeFlowRateEvent(command.getVolumeFlowRateId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit(), command.getValue());
    ...
    public void handle(UpdateVolumeFlowRateCommand command) throws Exception {
    	...
    	UpdateVolumeFlowRateEvent event = new UpdateVolumeFlowRateEvent(command.getVolumeFlowRateId(), command.getDenominatorMultiplier(), command.getDenominatorUnit(), command.getMultiplier(), command.getUnit(), command.getValue());        
