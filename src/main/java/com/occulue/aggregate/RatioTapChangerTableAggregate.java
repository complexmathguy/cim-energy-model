...
/**
 * Aggregate handler for RatioTapChangerTable as outlined for the CQRS pattern, all write responsibilities 
 * related to RatioTapChangerTable are handled here.
 * 
...
public class RatioTapChangerTableAggregate {  
    ...
    public RatioTapChangerTableAggregate(CreateRatioTapChangerTableCommand command) throws Exception {
    	...
    	CreateRatioTapChangerTableEvent event = new CreateRatioTapChangerTableEvent(command.getRatioTapChangerTableId());
    ...
    public void handle(UpdateRatioTapChangerTableCommand command) throws Exception {
    	...
    	UpdateRatioTapChangerTableEvent event = new UpdateRatioTapChangerTableEvent(command.getRatioTapChangerTableId());        
    ...
    @AggregateIdentifier
    private UUID ratioTapChangerTableId;
    

    private static final Logger LOGGER 	= Logger.getLogger(RatioTapChangerTableAggregate.class.getName());
}
