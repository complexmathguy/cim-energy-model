...
/**
 * Aggregate handler for TextDiagramObject as outlined for the CQRS pattern, all write responsibilities 
 * related to TextDiagramObject are handled here.
 * 
...
public class TextDiagramObjectAggregate {  
    ...
    public TextDiagramObjectAggregate(CreateTextDiagramObjectCommand command) throws Exception {
    	...
    	CreateTextDiagramObjectEvent event = new CreateTextDiagramObjectEvent(command.getTextDiagramObjectId(), command.getText());
    ...
    public void handle(UpdateTextDiagramObjectCommand command) throws Exception {
    	...
    	UpdateTextDiagramObjectEvent event = new UpdateTextDiagramObjectEvent(command.getTextDiagramObjectId(), command.getText());        
    ...
    @AggregateIdentifier
    private UUID textDiagramObjectId;
