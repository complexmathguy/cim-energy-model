...
public class CurrentLimitAggregate {  
    ...
    public CurrentLimitAggregate(CreateCurrentLimitCommand command) throws Exception {
    	...
    	CreateCurrentLimitEvent event = new CreateCurrentLimitEvent(command.getCurrentLimitId(), command.getValue());
    ...
    public void handle(UpdateCurrentLimitCommand command) throws Exception {
    	...
    	UpdateCurrentLimitEvent event = new UpdateCurrentLimitEvent(command.getCurrentLimitId(), command.getValue());        
