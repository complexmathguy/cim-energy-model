...
public class EarthFaultCompensatorEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final EarthFaultCompensatorRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(EarthFaultCompensatorEntityProjector.class.getName());
