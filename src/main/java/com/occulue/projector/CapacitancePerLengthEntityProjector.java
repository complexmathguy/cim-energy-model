...
public class CapacitancePerLengthEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final CapacitancePerLengthRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(CapacitancePerLengthEntityProjector.class.getName());
