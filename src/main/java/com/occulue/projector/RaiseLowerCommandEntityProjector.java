...
public class RaiseLowerCommandEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final RaiseLowerCommandRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(RaiseLowerCommandEntityProjector.class.getName());
