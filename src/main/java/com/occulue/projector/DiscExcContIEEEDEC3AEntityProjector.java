...
public class DiscExcContIEEEDEC3AEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final DiscExcContIEEEDEC3ARepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(DiscExcContIEEEDEC3AEntityProjector.class.getName());
