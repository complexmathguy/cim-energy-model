...
public class TextDiagramObjectEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final TextDiagramObjectRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(TextDiagramObjectEntityProjector.class.getName());
