...
public class SynchronousMachineUserDefinedEntityProjector {
	...
	// core constructor
	public SynchronousMachineUserDefinedEntityProjector(SynchronousMachineUserDefinedRepository repository ) {
    ...
    /**
     * Method to retrieve the SynchronousMachineUserDefined via an FindSynchronousMachineUserDefinedQuery
    ...
    public SynchronousMachineUserDefined find( UUID id ) {
    	...
    	try {
    		...
    		LOGGER.log( Level.WARNING, "Failed to find a SynchronousMachineUserDefined - {0}", exc.getMessage() );
    	}
    	return null;
    }
     ...
     */
    @SuppressWarnings("unused")
    public List<SynchronousMachineUserDefined> findAll( FindAllSynchronousMachineUserDefinedQuery query ) {
    	LOGGER.info("handling findAll using " + query.toString() );
    	try {
    		return repository.findAll();
    	}
    	catch( IllegalArgumentException exc ) {
    		LOGGER.log( Level.WARNING, "Failed to find all SynchronousMachineUserDefined - {0}", exc.getMessage() );
    	}
    	return null;
    }
    ...
    // --------------------------------------------------
	@Autowired
    protected final SynchronousMachineUserDefinedRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(SynchronousMachineUserDefinedEntityProjector.class.getName());
