...
public class ResistancePerLengthEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final ResistancePerLengthRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(ResistancePerLengthEntityProjector.class.getName());
