...
public class ConnectivityNodeEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final ConnectivityNodeRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(ConnectivityNodeEntityProjector.class.getName());
