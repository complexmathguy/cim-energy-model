...
public class PowerTransformerEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final PowerTransformerRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(PowerTransformerEntityProjector.class.getName());
