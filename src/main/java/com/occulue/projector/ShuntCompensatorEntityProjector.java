...
public class ShuntCompensatorEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final ShuntCompensatorRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(ShuntCompensatorEntityProjector.class.getName());
