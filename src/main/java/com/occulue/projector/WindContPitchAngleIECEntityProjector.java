...
public class WindContPitchAngleIECEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final WindContPitchAngleIECRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(WindContPitchAngleIECEntityProjector.class.getName());
