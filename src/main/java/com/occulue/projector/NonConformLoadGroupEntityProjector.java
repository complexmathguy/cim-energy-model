...
public class NonConformLoadGroupEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final NonConformLoadGroupRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(NonConformLoadGroupEntityProjector.class.getName());
