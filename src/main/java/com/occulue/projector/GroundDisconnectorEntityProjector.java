...
public class GroundDisconnectorEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final GroundDisconnectorRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(GroundDisconnectorEntityProjector.class.getName());
