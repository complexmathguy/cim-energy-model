...
public class StringMeasurementEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final StringMeasurementRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(StringMeasurementEntityProjector.class.getName());
