...
public class BoundaryExtensionsEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final BoundaryExtensionsRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(BoundaryExtensionsEntityProjector.class.getName());
