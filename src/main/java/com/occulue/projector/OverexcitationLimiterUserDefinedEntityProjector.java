...
public class OverexcitationLimiterUserDefinedEntityProjector {
	...
	// core constructor
	public OverexcitationLimiterUserDefinedEntityProjector(OverexcitationLimiterUserDefinedRepository repository ) {
    ...
    /**
     * Method to retrieve the OverexcitationLimiterUserDefined via an FindOverexcitationLimiterUserDefinedQuery
    ...
    public OverexcitationLimiterUserDefined find( UUID id ) {
    	...
    	try {
    		...
    		LOGGER.log( Level.WARNING, "Failed to find a OverexcitationLimiterUserDefined - {0}", exc.getMessage() );
    	}
    	return null;
    }
     ...
     */
    @SuppressWarnings("unused")
    public List<OverexcitationLimiterUserDefined> findAll( FindAllOverexcitationLimiterUserDefinedQuery query ) {
    	LOGGER.info("handling findAll using " + query.toString() );
    	try {
    		return repository.findAll();
    	}
    	catch( IllegalArgumentException exc ) {
    		LOGGER.log( Level.WARNING, "Failed to find all OverexcitationLimiterUserDefined - {0}", exc.getMessage() );
    	}
    	return null;
    }
    ...
    // --------------------------------------------------
	@Autowired
    protected final OverexcitationLimiterUserDefinedRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(OverexcitationLimiterUserDefinedEntityProjector.class.getName());
