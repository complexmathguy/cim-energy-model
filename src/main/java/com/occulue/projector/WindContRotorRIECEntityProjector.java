...
public class WindContRotorRIECEntityProjector {
    ...
    // --------------------------------------------------
	@Autowired
    protected final WindContRotorRIECRepository repository;

    private static final Logger LOGGER 	= Logger.getLogger(WindContRotorRIECEntityProjector.class.getName());
