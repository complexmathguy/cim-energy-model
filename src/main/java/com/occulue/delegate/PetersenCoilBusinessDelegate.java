 ...
 * <li>Improving the available of PetersenCoil related services in the case of a PetersenCoil business related service failing.</li>
 * <li>Exposes a simpler, uniform PetersenCoil interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill PetersenCoil business related services.</li>
 * </ol>
 * <p>
 * @author your_name_here
 */
public class PetersenCoilBusinessDelegate 
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
        	...
        	// -------------------------------------- 
			if ( command.getPetersenCoilId() == null )
				command.setPetersenCoilId( UUID.randomUUID() );
    		...
    		// ---------------------------------------
    		// issue the CreatePetersenCoilCommand - by convention the future return value for a create command
        	// that is handled by the constructor of an aggregate will return the UUID 
    		// ---------------------------------------
        	completableFuture = commandGateway.send( command );
        	
			LOGGER.log( Level.INFO, "return from Command Gateway for CreatePetersenCoilCommand of PetersenCoil is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {	
        ...
        try {  
            ...
            final String errMsg = "Unable to delete PetersenCoil using Id = "  + command.getPetersenCoilId();
            LOGGER.log( Level.WARNING, errMsg, exc );
            throw new ProcessingException( errMsg, exc );
        }
        finally {
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<PetersenCoil> futureEntity = queryGateway.query(new FindPetersenCoilQuery( new LoadPetersenCoilFilter( summary.getPetersenCoilId() ) ), ResponseTypes.instanceOf(PetersenCoil.class));
     ...
     */
    public List<PetersenCoil> getAllPetersenCoil() 
    throws ProcessingException {
        List<PetersenCoil> list = null;

        try {
        	CompletableFuture<List<PetersenCoil>> futureList = queryGateway.query(new FindAllPetersenCoilQuery(), ResponseTypes.multipleInstancesOf(PetersenCoil.class));
	 ...
	 * @return		PetersenCoil
	 */
	protected PetersenCoil load( UUID id ) throws ProcessingException {
		petersenCoil = PetersenCoilBusinessDelegate.getPetersenCoilInstance().getPetersenCoil( new PetersenCoilFetchOneSummary(id) );	
		return petersenCoil;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(PetersenCoilBusinessDelegate.class.getName());
