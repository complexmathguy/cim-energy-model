...
//************************************************************************
    ...
    */
	 ...
	 * @return		HydroPump
	 */
	protected HydroPump load( UUID id ) throws ProcessingException {
		hydroPump = HydroPumpBusinessDelegate.getHydroPumpInstance().getHydroPump( new HydroPumpFetchOneSummary(id) );	
		return hydroPump;
	}
