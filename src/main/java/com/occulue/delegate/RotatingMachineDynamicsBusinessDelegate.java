...
//************************************************************************
    ...
    */
	 ...
	 */
	protected RotatingMachineDynamics load( UUID id ) throws ProcessingException {
		rotatingMachineDynamics = RotatingMachineDynamicsBusinessDelegate.getRotatingMachineDynamicsInstance().getRotatingMachineDynamics( new RotatingMachineDynamicsFetchOneSummary(id) );	
		return rotatingMachineDynamics;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(RotatingMachineDynamicsBusinessDelegate.class.getName());
