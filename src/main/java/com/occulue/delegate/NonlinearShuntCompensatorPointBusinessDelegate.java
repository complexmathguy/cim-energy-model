...
//************************************************************************
    ...
    */
	 ...
	 */
	protected NonlinearShuntCompensatorPoint load( UUID id ) throws ProcessingException {
		nonlinearShuntCompensatorPoint = NonlinearShuntCompensatorPointBusinessDelegate.getNonlinearShuntCompensatorPointInstance().getNonlinearShuntCompensatorPoint( new NonlinearShuntCompensatorPointFetchOneSummary(id) );	
		return nonlinearShuntCompensatorPoint;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(NonlinearShuntCompensatorPointBusinessDelegate.class.getName());
