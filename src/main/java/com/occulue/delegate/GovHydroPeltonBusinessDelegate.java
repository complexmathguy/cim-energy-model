...
//************************************************************************
    ...
    */
	 ...
	 */
	protected GovHydroPelton load( UUID id ) throws ProcessingException {
		govHydroPelton = GovHydroPeltonBusinessDelegate.getGovHydroPeltonInstance().getGovHydroPelton( new GovHydroPeltonFetchOneSummary(id) );	
		return govHydroPelton;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(GovHydroPeltonBusinessDelegate.class.getName());
