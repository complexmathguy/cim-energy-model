...
//************************************************************************
    ...
    */
	 ...
	 */
	protected DomainVersion load( UUID id ) throws ProcessingException {
		domainVersion = DomainVersionBusinessDelegate.getDomainVersionInstance().getDomainVersion( new DomainVersionFetchOneSummary(id) );	
		return domainVersion;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(DomainVersionBusinessDelegate.class.getName());
