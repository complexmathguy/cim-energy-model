...
//************************************************************************
    ...
    */
	 ...
	 */
	protected VisibilityLayer load( UUID id ) throws ProcessingException {
		visibilityLayer = VisibilityLayerBusinessDelegate.getVisibilityLayerInstance().getVisibilityLayer( new VisibilityLayerFetchOneSummary(id) );	
		return visibilityLayer;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(VisibilityLayerBusinessDelegate.class.getName());
