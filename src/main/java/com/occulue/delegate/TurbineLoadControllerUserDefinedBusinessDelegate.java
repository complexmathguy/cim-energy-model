...
//************************************************************************
    ...
    */
	 ...
	 */
	protected TurbineLoadControllerUserDefined load( UUID id ) throws ProcessingException {
		turbineLoadControllerUserDefined = TurbineLoadControllerUserDefinedBusinessDelegate.getTurbineLoadControllerUserDefinedInstance().getTurbineLoadControllerUserDefined( new TurbineLoadControllerUserDefinedFetchOneSummary(id) );	
		return turbineLoadControllerUserDefined;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(TurbineLoadControllerUserDefinedBusinessDelegate.class.getName());
