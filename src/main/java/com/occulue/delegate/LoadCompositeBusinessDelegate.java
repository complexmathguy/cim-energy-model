...
//************************************************************************
    ...
    */
	 ...
	 */
	protected LoadComposite load( UUID id ) throws ProcessingException {
		loadComposite = LoadCompositeBusinessDelegate.getLoadCompositeInstance().getLoadComposite( new LoadCompositeFetchOneSummary(id) );	
		return loadComposite;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(LoadCompositeBusinessDelegate.class.getName());
