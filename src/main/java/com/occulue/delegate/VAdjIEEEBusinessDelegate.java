...
//************************************************************************
    ...
    */
	 ...
	 * @return		VAdjIEEE
	 */
	protected VAdjIEEE load( UUID id ) throws ProcessingException {
		vAdjIEEE = VAdjIEEEBusinessDelegate.getVAdjIEEEInstance().getVAdjIEEE( new VAdjIEEEFetchOneSummary(id) );	
		return vAdjIEEE;
	}
