...
//************************************************************************
    ...
    */
	 ...
	 * @return		SwitchProxy
	 */
	protected SwitchProxy load( UUID id ) throws ProcessingException {
		switchProxy = SwitchProxyBusinessDelegate.getSwitchProxyInstance().getSwitchProxy( new SwitchProxyFetchOneSummary(id) );	
		return switchProxy;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(SwitchProxyBusinessDelegate.class.getName());
