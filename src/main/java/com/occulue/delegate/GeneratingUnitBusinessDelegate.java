...
//************************************************************************
    ...
    */
	 ...
	 */
	protected GeneratingUnit load( UUID id ) throws ProcessingException {
		generatingUnit = GeneratingUnitBusinessDelegate.getGeneratingUnitInstance().getGeneratingUnit( new GeneratingUnitFetchOneSummary(id) );	
		return generatingUnit;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(GeneratingUnitBusinessDelegate.class.getName());
