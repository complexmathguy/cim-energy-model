...
//************************************************************************
    ...
    */
	 ...
	 */
	protected SynchronousMachineEquivalentCircuit load( UUID id ) throws ProcessingException {
		synchronousMachineEquivalentCircuit = SynchronousMachineEquivalentCircuitBusinessDelegate.getSynchronousMachineEquivalentCircuitInstance().getSynchronousMachineEquivalentCircuit( new SynchronousMachineEquivalentCircuitFetchOneSummary(id) );	
		return synchronousMachineEquivalentCircuit;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(SynchronousMachineEquivalentCircuitBusinessDelegate.class.getName());
