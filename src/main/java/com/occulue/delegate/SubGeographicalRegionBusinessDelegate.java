...
//************************************************************************
    ...
    */
	 ...
	 */
	protected SubGeographicalRegion load( UUID id ) throws ProcessingException {
		subGeographicalRegion = SubGeographicalRegionBusinessDelegate.getSubGeographicalRegionInstance().getSubGeographicalRegion( new SubGeographicalRegionFetchOneSummary(id) );	
		return subGeographicalRegion;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(SubGeographicalRegionBusinessDelegate.class.getName());
