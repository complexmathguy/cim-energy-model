...
//************************************************************************
    ...
    */
	 ...
	 * @return		ExcIEEEDC4B
	 */
	protected ExcIEEEDC4B load( UUID id ) throws ProcessingException {
		excIEEEDC4B = ExcIEEEDC4BBusinessDelegate.getExcIEEEDC4BInstance().getExcIEEEDC4B( new ExcIEEEDC4BFetchOneSummary(id) );	
		return excIEEEDC4B;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(ExcIEEEDC4BBusinessDelegate.class.getName());
