...
//************************************************************************
    ...
    */
	 ...
	 * @return		BaseVoltage
	 */
	protected BaseVoltage load( UUID id ) throws ProcessingException {
		baseVoltage = BaseVoltageBusinessDelegate.getBaseVoltageInstance().getBaseVoltage( new BaseVoltageFetchOneSummary(id) );	
		return baseVoltage;
	}
...
//************************************************************************
    ...
    private static final Logger LOGGER 			= Logger.getLogger(BaseVoltageBusinessDelegate.class.getName());
