...
public class GeneratingUnitSubscriber extends BaseSubscriber {
    ...
    public SubscriptionQueryResult<List<GeneratingUnit>, GeneratingUnit> generatingUnitSubscribe() {
        return queryGateway
                .subscriptionQuery(new FindAllGeneratingUnitQuery(), 
                		ResponseTypes.multipleInstancesOf(GeneratingUnit.class),
                		ResponseTypes.instanceOf(GeneratingUnit.class));
    }

    public SubscriptionQueryResult<GeneratingUnit, GeneratingUnit> generatingUnitSubscribe(@DestinationVariable UUID generatingUnitId) {
        return queryGateway
                .subscriptionQuery(new FindGeneratingUnitQuery(new LoadGeneratingUnitFilter(generatingUnitId)), 
                		ResponseTypes.instanceOf(GeneratingUnit.class),
                		ResponseTypes.instanceOf(GeneratingUnit.class));
    }
