...
public class BusbarSectionSubscriber extends BaseSubscriber {
    ...
    public SubscriptionQueryResult<List<BusbarSection>, BusbarSection> busbarSectionSubscribe() {
        return queryGateway
                .subscriptionQuery(new FindAllBusbarSectionQuery(), 
                		ResponseTypes.multipleInstancesOf(BusbarSection.class),
                		ResponseTypes.instanceOf(BusbarSection.class));
    }

    public SubscriptionQueryResult<BusbarSection, BusbarSection> busbarSectionSubscribe(@DestinationVariable UUID busbarSectionId) {
        return queryGateway
                .subscriptionQuery(new FindBusbarSectionQuery(new LoadBusbarSectionFilter(busbarSectionId)), 
                		ResponseTypes.instanceOf(BusbarSection.class),
                		ResponseTypes.instanceOf(BusbarSection.class));
    }
